...
public class Product {
	...
	//Stage 1
	// - Refactor->Rename it by using a proper name

	// this class is used for... => don't write this!! change the names

	// - Remove magic numbers - name them with final static 

	//Ex: public final static int PREMIUM_ACCOUNT_MIN_AGE=10;
